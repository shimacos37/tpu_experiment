...
def batch_norm_relu(
    inputs, is_training, relu=True, init_zero=False, data_format="channels_first"
):
...
def block_group(
    ...
    Args:
      ...
      d: `function` for the block to use within the model
...
def resnet_v1_generator(
    ...
    Args:
      d: `function` for the block to use within the model. Either
    ...
    def model(inputs, is_training):
        ...
        inputs = tf.reshape(inputs, [-1, 2048 if d is bottleneck_block else 512])
