...
def main(unused_argv):
    ...
    assert FLAGS.data_dir is not None, "Provide training data path via " "--data_dir."
    ...
    with strategy.scope():
        ...
        imagenet_train = ImageNetInput(
            is_training=True, data_dir=FLAGS.data_dir, batch_size=FLAGS.train_batch_size
        )
        logging.info("Creating ImageNet eval input")
        imagenet_eval = ImageNetInput(
            is_training=False, data_dir=FLAGS.data_dir, batch_size=FLAGS.eval_batch_size
        )
